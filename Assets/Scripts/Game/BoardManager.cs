...
namespace Guardian.Game
{
    public class BoardManager : MonoBehaviour
    {
        ...
        // дл€ cancel kill-mode по клику мимо карты
        ...
        void Update()
        {
            // отмена KillMode по клику Умимо картФ
        ...
        void EnterKillMode()
        {
            ...
            if (killButtonLabel) killButtonLabel.text = "ќтмена";
